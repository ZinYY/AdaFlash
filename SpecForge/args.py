...
# Upstream: SpecForge/specforge/args.py
...
class SGLangBackendArgs:
    ...
    def to_kwargs(self) -> Dict[str, Any]:
        return dict(
            ...
            # newest SGLang ServerArgs uses enable_piecewise_cuda_graph
            # enable_piecewise_cuda_graph=self.sglang_enable_piecewise_cuda_graph,
            # local SGLang ServerArgs uses disable_piecewise_cuda_graph
